...
struct InferenceRuntimeSettings {
  ...
  std::string models_root = "/naim/shared/models";
  std::string model_cache_dir = "/naim/shared/models/cache";
  std::string runtime_log_dir = "/naim/shared/logs/infer";
  int api_port = 8000;
  ...
  std::string gguf_cache_dir = "/naim/shared/models/gguf";
  std::string infer_log_dir = "/naim/shared/logs/infer";
  int llama_port = 8000;
