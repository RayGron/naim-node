...
: "${NAIM_MAIN_PUBLIC_HOST:=hpc.chainzano.com}"
: "${NAIM_MAIN_PUBLIC_ORIGIN:=https://${NAIM_MAIN_PUBLIC_HOST}}"
: "${NAIM_WEBAUTHN_RP_ID:=${NAIM_MAIN_PUBLIC_HOST}}"
: "${NAIM_WEBAUTHN_ORIGIN:=${NAIM_MAIN_PUBLIC_ORIGIN}}"
: "${NAIM_WEBAUTHN_RP_NAME:=naim-node}"
