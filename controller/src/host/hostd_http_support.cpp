...
HostdHttpSupport::HostdHttpSupport(
    naim::controller::HostRegistryEventSink host_registry_event_sink)
...
std::optional<long long> HostdHttpSupport::timestamp_age_seconds(
  ...
  return naim::controller::ControllerTimeSupport::TimestampAgeSeconds(value);
}

const naim::controller::HostRegistryEventSink& HostdHttpSupport::host_registry_event_sink() const {
